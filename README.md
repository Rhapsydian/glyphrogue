...
the first real downstream game built on this engine, dogfooding the
public API surface end to end. Its Phase 1 (2026-07-26) found and fixed
four real gaps here live: `deserialize` wasn't forwarding
